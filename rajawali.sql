...
--
INSERT INTO `customer_detail` (`id`, `id_customer`, `email`)
VALUES (6, '6038a60a4efab', 'ahmad@gmail.com'),
...
CREATE TABLE `iso` (
  ...
  `category` enum(
    ...
    'BASED',
    'OTHER'
  ) DEFAULT NULL COMMENT '''TOYS'',''BABY_WEAR'',''BICYCLE'',''OTHERS'',''BASED'',''OTHER''',
...
VALUES (
  ...
  (
    44,
    'Based on laboratory quotation no 0757',
    'BASED',
    'N',
    '2021-03-08 00:34:31',
    '1',
...
--
INSERT INTO `submition_tos` (
    `id`,
    `id_submition_tos`,
    `id_term_of_service_detail`,
    `created_at`,
    `created_by`,
    `deleted_at`
  )
...
--
INSERT INTO `term_of_service_detail` (
    `id`,
    `id_term_of_service`,
    `type`,
    `information`,
