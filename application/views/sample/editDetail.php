                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="quantity" placeholder="Quantity" value="<?= $detail->quantity ?>">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="sampleCode" placeholder="Sample Code" value="<?= $detail->id_sample ?>" readonly>
                                </div>
                                <div class="form-group">
