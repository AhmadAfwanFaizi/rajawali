                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="doNotShowPass" value="BASED">
                                        <b>Do not show PASS/FAIL conclusion in test report</b>
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="retainSample" value="BASED">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="iso[]" value="BASED">
                                            <b>Based on laboratory quotation no 0757</b>
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">
