...
// MODEL ABSENSI ================================================================================================================
    ...
    function get_datatables_data_absen($param = null) {
        ...
        $this->db->limit(@$_POST['length'], @$_POST['start']);
        // where
            $this->db->where("A.status = 'MASUK' AND DATE_FORMAT(A.dibuat, '%Y-%m-%d') BETWEEN '$param[tanggalMulai]' AND '$param[tanggalBerakhir]' AND K.id_divisi = ", $param['idDivisi']);
...
# ABSEN ==========================================================================================================================
    ...
    var $column_order_absen = array(null, 'A.nip', 'nama', 'tanggal_absen', 'waktu_absen');
    var $column_search_absen = array('A.nip','nama', 'A.dibuat'); 
    var $order_absen = array('A.nip' => 'asc'); 
    ...
    function get_datatables_absen() {
        ...
        $this->db->limit(@$_POST['length'], @$_POST['start']);
        // where
        $this->db->where('A.status IS NULL AND K.jabatan =', "KETUA_DIVISI");
